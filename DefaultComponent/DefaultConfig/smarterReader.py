...
if __name__ == "__main__":
    ...
    for input_config in configurationDict:
        ...
        for name, row in namesDF.iterrows():
            if row['type'] == "IN":
                commandsList.append((name, 'AVDL', configurationDict[input_config]["IN"]))
                commandsList.append((name, 'AVDR', configurationDict[input_config]["IN"]))
            elif row['type'] == "SN":
                commandsList.append((name, 'AVDL', configurationDict[input_config]["SN"]))
                commandsList.append((name, 'AVDR', configurationDict[input_config]["SN"]))
            elif row['type'] == "MN":
                commandsList.append((name, 'AVDL', configurationDict[input_config]["MN"]))
                commandsList.append((name, 'AVDR', configurationDict[input_config]["MN"]))
