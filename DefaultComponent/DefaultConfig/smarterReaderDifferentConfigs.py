...
if __name__ == "__main__":
    ...
    # this block of codes allows me to check various configurations for a
    # specific neuron (like AVD down below)
    namesDF = createDict()
        ...
        # presynaptic cell is motor
            ...
            for post_name, post_row in namesDF.iterrows():   
                if post_row['type'] == "IN":
                    ...
                    commandsList.append((pre_name, post_name, '+'))
#    commandsList.append(("PVCL", "VB03", '-'))
#    commandsList.append(("PVCR", "VB03", '-'))
#    commandsList.append(("PVCL", "VB04", '-'))
#    commandsList.append(("PVCR", "VB04", '-'))
#    commandsList.append(("PVCL", "VB05", '-'))
#    commandsList.append(("PVCR", "VB05", '-'))
#    commandsList.append(("PVCL", "VB06", '-'))
#    commandsList.append(("PVCR", "VB06", '-'))
#    commandsList.append(("PVCL", "VB07", '-'))
#    commandsList.append(("PVCR", "VB07", '-'))
#    commandsList.append(("PVCL", "VB08", '-'))
#    commandsList.append(("PVCR", "VB08", '-'))
#    commandsList.append(("PVCL", "VB10", '-'))
#    commandsList.append(("PVCR", "VB10", '-'))
#    commandsList.append(("PVCL", "VB11", '-'))
#    commandsList.append(("PVCR", "VB11", '-'))
